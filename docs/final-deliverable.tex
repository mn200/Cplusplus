...
\title{A Formal Semantics for (Much of) \cpp\\
(commissioned by QinetiQ)}
...
12$\,$000 lines; this document tries to cover both the important details,
and to describe at a high level the less important details.  
...
accompanying rule-texts with English prose.  Where prose and rule
