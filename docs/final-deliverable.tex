...
that an operational semantics never ``blocks'' but continues to only
finishes program evaluation in a valid final state (the return of a
value, or some sort of abort state, say).
...
to the article by Wasserrab \emph{et al}
