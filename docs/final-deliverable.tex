...
function application.)  The \ruleid{virtual-function-member-select}
rule (see Figure~\ref{fig:virtual-function-member-select}) governs the
...
\label{fig:virtual-function-member-select}
\end{figure}
